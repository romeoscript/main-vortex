...
<head>
    ...
    <title>Vortex - CryptoExchange</title>
            ...
            <div class="container">
                ...
                <div class="header-wrap">
                    ...
                    <div class="header-logo">
                        <a href="index.html"><img src="assets/images/Vortex Logo-alt.png" alt=""></a>
                    </div>
...
<li style="padding:5px;"><a href="{{route('login')}}" class="btn btn-primary">Login</a></li> 
                    ...
                    <!-- <div class="header-meta"> -->
                        ...
                        <!-- Header Cart End -->
                        <!-- Header Toggle Start -->
                        <div class="header-toggle d-none d-lg-none">
        ...
        <div class="offcanvas offcanvas-start" id="offcanvasExample">
            <div class="offcanvas-header">
                ...
                <div class="offcanvas-logo">
                    <a href="index.html"><img src="assets/images/Vortex Logo_101157.jpg" alt=""></a>
                </div>
                <!-- Offcanvas Logo End -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="hero-content text-center">
                            <h3 class="sub-title" data-aos-delay="600" data-aos="fade-up"> Buy and Sell</h3>
                            <h2 class="title" data-aos="fade-up" data-aos-delay="700"> Cryptocurrency Easily and Fast With Bank Transfer & E-Payment</h2>
                            <div class="hero-btn" data-aos="fade-up" data-aos-delay="900">
                                <a class="btn" href="{{route('register')}}">Trade Crypto</a>
                            </div>
                        </div>
                        <!-- Hero Content End -->
                    </div>
        ...
        <!-- About Start -->
        <div class="section about-section-5 section-padding-03" style="background-image: url(assets/images/ser-2-bg.png);">
            <div class="container">
                <!-- About Wrap Start -->
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="about-left">
                                <div class="section-title">
                                    ...
                                    <h2 class="title">We are <b>vortex</b>, we specialise in making it easy to buy and sell crypto within minutes through bank transfer or e-payment</h2>
                                </div>
                            </div>
                            <!-- About Left End -->
                        </div>
                        <div class="col-lg-6">
                            ...
                            <div class="about-right">
                                <p>Here at vortex, we offer world-class teaching classes on everything Cryptocurrency from premium classes to 85% accurate trading signals on our instagram page. we also teach on how to get Crypto Jobs that would pay you in crypto..</p>
                                <div class="about-author">
                                    <div class="author-img">
                                        <img src="assets/images/sign-2.png" alt="">
                                    </div>
                                    <div class="author-text">
                                        <h4 class="name">Peter Benjamin</h4>
                                        <span class="designation">CEO, Vortex</span>
                                    </div>
                                </div>
                            </div>
                            <!-- About Right End -->
                ...
                <div class="skill-img-wrap">
                    <div class="row">
                        <div class="col-lg-4 col-sm-6">
                            ...
                            <div class="skill-img-item">
                                <div class="skill-img text-center">
                                    <a class="image" href="#"><img src="assets/images/skill-5.jpg" alt=""></a>
                                    <div class="skill-img-text">
                                        <h3 class="title"><a href="#">No Third Party</a></h3>
                                    </div>
                                </div>
                            </div>
                            <!--  Skill Image Item Start -->
                        ...
                        <div class="col-lg-4 col-sm-6">
                            ...
                            <div class="skill-img-item">
                                <div class="skill-img text-center">
                                    <a class="image" href="#"><img src="assets/images/skill-6.jpg" alt=""></a>
                                    <div class="skill-img-text">
                                        <h3 class="title"><a href="#"> User-Friendly Interface</a></h3>
                                    </div>
                                </div>
                            </div>
                            <!--  Skill Image Item Start -->
                        ...
                        <div class="col-lg-4 col-sm-6">
                            ...
                            <div class="skill-img-item">
                                <div class="skill-img text-center">
                                    <a class="image" href="#"><img src="assets/images/skill-7.jpg" alt=""></a>
                                    <div class="skill-img-text">
                                        <h3 class="title"><a href="#"> Active Customer </a></h3>
                                    </div>
                                </div>
                            </div>
                            <!--  Skill Image Item Start -->
        ...
        <!-- Counter Start -->
        <div class="section counter-section counter-section-2 counter-section-3 section-padding" style="background-image: url(assets/images/counter-bg-3.jpg);">
            <div class="container">
                <div class="row">
                    <div class="col-lg-7">
    ...
    <div class="section footer-section" style="background-image: url(assets/images/footer-bg-3.jpg);">
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="footer-widget-about">
                            <a class="footer-logo" href="index.html"><img src="assets/images/Vortex Logo-alt-white.png" alt="Logo"></a>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-md-6">
                            ...
                            <div class="copyright-text">
                                <p>© Copyrights 2022 Vortex All rights reserved. </p>
                            </div>
